...
- **Component Tests**: Use when creating new Svelte components or modifying existing ones. These tests take the form of **interaction testing**, where we verify component rendering, reactivity to props, and emitted events in a simulated browser environment, ensuring UI pieces work as expected.
