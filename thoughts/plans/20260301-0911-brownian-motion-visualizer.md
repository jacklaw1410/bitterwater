...
- [x] All unit tests pass: `bun test:unit --run src/lib/utils/brownian-motion.spec.ts`
...
- [x] Component tests pass: `bun test:unit --run src/lib/components/brownian-motion/Controls.spec.ts`
- [x] Type checking passes: `bun check`
- [x] Linting passes: `bun lint`
