...
1. Immediately read any provided files FULLY
...
2. **Create a research todo list** using `todowrite` tool to track exploration tasks
...
1. **Write the plan** to `thoughts/plans/YYYYMMDD-description.md`
   - Format `YYYYMMDD-description.md` where
     - YYYYMMDD is the current date
     - description is a brief kebab-case description
   - Examples: `20230501-authentication-flow.md`
...
1. **Present the draft plan location**:
   ...
   `thoughts/plans/YYYYMMDD-description.md`
...
5. **Track Progress**:
   - Use `todowrite` tool to track planning tasks
...
3. **Provide detailed instructions** including file:line references
4. **Wait for all tasks to complete** before synthesizing
5. **Verify sub-task results**
